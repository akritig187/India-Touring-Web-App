                        ...
                        <div id="login" class="animate form">
                            ...
                            <?php include('errors.php'); ?>
                                ...
                                <p> 
                                    ...
                                    <input id="usernamesignup" name="first_name" required="required" type="text" placeholder="Shahrukh" />
                                </p>

                                <p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Last Name</label>
                                    <input id="usernamesignup" name="last_name" required="required" type="text" placeholder="Khan" />
                                </p>

                                <p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Username</label>
                                    <input id="usernamesignup" name="username" required="required" type="text" placeholder="shahrukhkhan" />
                                </p>
